...
import io.mcp.httpclient.domain.model.HttpRequestDomain
import io.mcp.httpclient.domain.model.RequestResult
import io.mcp.httpclient.domain.model.Url
...
class CacheBenchmarkTest {
    ...
    private class NoOpCache : CacheRepository {
        override suspend fun get(key: io.mcp.httpclient.domain.model.CacheKey): 
            io.mcp.httpclient.domain.model.HttpResponseDomain? = null
        
        override suspend fun put(
            key: io.mcp.httpclient.domain.model.CacheKey,
            response: io.mcp.httpclient.domain.model.HttpResponseDomain
        ) {}
        
        override suspend fun invalidate(key: io.mcp.httpclient.domain.model.CacheKey) {}
