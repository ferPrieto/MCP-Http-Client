...
fun TcpRequestDomain.toTcpRequest(): ferprieto.mcp.httpclient.models.TcpRequest =
    ferprieto.mcp.httpclient.models.TcpRequest(
        host = host.value,
        port = port.value,
        message = message,
...
fun ferprieto.mcp.httpclient.models.TcpResponse.toDomain(): TcpResponseDomain =
    if (success) {
